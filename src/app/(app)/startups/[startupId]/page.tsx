      ...
      <section className="section-block">
        <div className="stat-tiles">
          <div className="stat-tile">
            ...
            <div className="lbl">{t('بطاقات نموذج العمل', 'Business-model cards')}</div>
          </div>
          <div className="stat-tile">
          ...
          <div className="stat-tile">
            ...
            <div className="lbl">{t('أهداف SMART', 'SMART goals')}</div>
          </div>
          <div className="stat-tile">
            <div className="val eng">{startup.users_count}</div>
            <div className="lbl">{t('مستخدمون', 'Users')}</div>
          </div>
        </div>
      </section>
